...
$string['logincommentsforced'] = 'Да, от зарегистрированных пользователей, для всех записей';
...
// Help strings.
$string['allowcomments_help'] = '<strong>Да, от зарегистрированных пользователей, для всех записей</strong> разрешает комментарии от пользователей, у которых есть доступ к записи, для всех записей, и запрещает менять это поведение на уровне отдельных записей.

<strong>Да, от зарегистрированных пользователей</strong> разрешает комментарии от пользователей, у которых есть доступ к записи. Авторы записей могут запретить комментарии на уровне отдельных записей.

<strong>Да, от кого угодно</strong> разрешает комментарии и от зарегистрированных, и от незарегистрированных пользователей. Вы получите уведомление по электронной почте о необходимости подтвердить или отклонить комментарии от незарегистрированных пользователей. Авторы записей могут запретить или ограничить комментарии на уровне отдельных записей.

<strong>Нет</strong> запрещает всем оставлять комментарии к записям.';
